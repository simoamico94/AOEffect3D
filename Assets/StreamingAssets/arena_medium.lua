...
PaymentQty = 1000    -- Quantity of tokens for registration
BonusQty = 1000        -- Bonus token quantity for winners
TransferQty = 1000000
...
Handlers.add(
    ...
    function (Msg)
        print("Transfering Tokens: " .. tostring(TransferQty))
        ao.send({
            Target = ao.id,
            Action = "Transfer",
            Quantity = tostring(TransferQty),
            Recipient = Msg.From,
        })
    end
)